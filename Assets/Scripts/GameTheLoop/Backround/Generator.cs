...
public class Generator : MonoBehaviour
{
    ...
    private void OnEnable() => _changer.ChangeLocation += ChangeLocation;
    private void OnDisable() => _changer.ChangeLocation -= ChangeLocation;
    ...
    {
        SceneCleaner.Clean(ObjectManager.instance.SpaceObjectList);
        SpawnPlanet(Random.Range(-4, transform.position.y - 2));
        SpawnGalaxy();
    }
