...
public class SpaceObject : MonoBehaviour
{
    ...
    protected virtual void OnEnable() => ObjectManager.instance.SpaceObjectList.AddLast(gameObject);
    protected virtual void OnDisable() => ObjectManager.instance.SpaceObjectList.Remove(gameObject);
