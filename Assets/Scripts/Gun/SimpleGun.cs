...
public class SimpleGun : MonoBehaviour
{
    ...
    protected virtual void Shoot(Vector2 direction) => Instantiate(b_lazerPrefab, b_transform.position, Quaternion.Euler(0, 0, b_angle)).SetDirectionFromGun(this, direction);
}
